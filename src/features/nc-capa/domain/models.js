...
export const NC_PERMISSIONS = {
  ...
  DCC_LINK_VIEW: 'NC_CAPA_DCC_LINK_VIEW',
  DCC_LINK_CREATE: 'NC_CAPA_DCC_LINK_CREATE',
  DCC_LINK_REMOVE: 'NC_CAPA_DCC_LINK_REMOVE'
};
...
export const DccLinkageType = {
  NEW_DAR_CREATED: 'NEW_DAR_CREATED',
  REVISION_DAR_CREATED: 'REVISION_DAR_CREATED',
  OBSOLETE_DAR_CREATED: 'OBSOLETE_DAR_CREATED',
  PERIODIC_REVIEW_CREATED: 'PERIODIC_REVIEW_CREATED',
  EXISTING_DAR_LINKED: 'EXISTING_DAR_LINKED',
  EXISTING_PERIODIC_REVIEW_LINKED: 'EXISTING_PERIODIC_REVIEW_LINKED',
  DOCUMENT_LINKED_REFERENCE: 'DOCUMENT_LINKED_REFERENCE'
};

export const DccLinkageStatus = {
