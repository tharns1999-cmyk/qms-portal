...
import { Check, CornerUpLeft, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h2 className="text-2xl font-bold text-gray-800 ">Review Task: {dar.id}</h2>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <h3 className="font-semibold text-gray-800  border-b pb-2 mb-4">ดำเนินการ (Reviewer)</h3>
        <div className="space-y-4">
          ...
          <div className="flex gap-4 pt-2">
            <button 
              ...
              className="flex-1 flex justify-center items-center gap-2 py-3 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors"
            >
              <Check className="w-5 h-5" /> Approve Review
            </button>
            <button 
