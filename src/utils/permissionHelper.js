...
export const getUserPermissions = (user) => {
  ...
  if (user.department === 'QA' || user.department === 'QC' || user.isQaqc) {
    permissions.push(
      ...
      PERMISSIONS.CAPA_VIEW_ALL,
      PERMISSIONS.CAPA_CREATE,
      PERMISSIONS.CAPA_REVIEW,
      PERMISSIONS.CAPA_ASSIGN_OWNER,
      PERMISSIONS.CAPA_VERIFY,
      PERMISSIONS.CAPA_EFFECTIVENESS_CHECK,
      PERMISSIONS.CAPA_CLOSE,
      PERMISSIONS.CAPA_REOPEN,
      PERMISSIONS.CAPA_ADMIN,
      PERMISSIONS.CAPA_AUDIT_VIEW,
    ...
    permissions.push(
      ...
      PERMISSIONS.CAPA_CREATE,
      PERMISSIONS.CAPA_RCA,
      PERMISSIONS.CAPA_PLAN_CREATE,
      PERMISSIONS.CAPA_ACTION_EXECUTE,
      PERMISSIONS.CAPA_EVIDENCE_SUBMIT
    );
