...
export const MASTER_DATA_USER = [
  ...
  { id: 'U004', name: 'คุณเรย์', position: 'General Manager', level: 6, depts: [], permissions: ['NC_CAPA_VIEW', 'NC_CAPA_VIEW_ALL', 'NC_CAPA_AUDIT_VIEW', 'NCR_VIEW_ALL', 'HOLD_VIEW_ALL', 'CAPA_VIEW_ALL', 'QUALITY_EVENT_MANAGEMENT_VIEW', 'HOLD_RELEASE_APPROVE', 'HOLD_DISPOSITION_APPROVE', 'QUALITY_EVENT_MANAGEMENT_APPROVE'] },
  ...
  { id: 'U009', name: 'คุณนัท', position: 'Managing Director', level: 8, depts: [], permissions: ['NC_CAPA_VIEW', 'NC_CAPA_VIEW_ALL', 'NC_CAPA_AUDIT_VIEW', 'NCR_VIEW_ALL', 'HOLD_VIEW_ALL', 'CAPA_VIEW_ALL', 'QUALITY_EVENT_MANAGEMENT_VIEW', 'HOLD_RELEASE_APPROVE', 'HOLD_DISPOSITION_APPROVE', 'QUALITY_EVENT_MANAGEMENT_APPROVE'] }
];
