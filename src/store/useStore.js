...
export const MASTER_DATA_USER = [
  { id: 'U001', name: 'Admin QA (DCC)', position: 'Officer', level: 1, isDcc: true, depts: ['QA'], permissions: ['NC_CAPA_VIEW', 'NC_CAPA_VIEW_ALL', 'NC_CAPA_CREATE', 'NC_CAPA_SCREEN', 'NC_CAPA_ASSIGN_OWNER', 'NC_CAPA_ADMIN', 'NC_CAPA_AUDIT_VIEW', 'NC_CAPA_PLAN_REVIEW'] },
  { id: 'U002', name: 'ธนาวุฒิ สมควรกิจดำรง', position: 'Production Supervisor', level: 4, depts: ['PD'], permissions: ['NC_CAPA_VIEW', 'NC_CAPA_CREATE', 'NC_CAPA_OWNER_ACTION', 'NC_CAPA_RCA_COMPLETE', 'NC_CAPA_PLAN_CREATE'] },
  { id: 'U003', name: 'กัลยาณี พลไกร', position: 'Production Assistant Manager', level: 5, depts: ['PD', 'QA'], permissions: ['NC_CAPA_VIEW', 'NC_CAPA_CREATE', 'NC_CAPA_OWNER_ACTION', 'NC_CAPA_RCA_COMPLETE', 'NC_CAPA_PLAN_CREATE'] },
  { id: 'U004', name: 'คุณเรย์', position: 'General Manager', level: 6, depts: [], permissions: ['NC_CAPA_VIEW', 'NC_CAPA_VIEW_ALL', 'NC_CAPA_AUDIT_VIEW'] },
  { id: 'U005', name: 'บีม', position: 'QAQC Supervisor', level: 4, depts: ['QA'], permissions: ['NC_CAPA_VIEW', 'NC_CAPA_VIEW_ALL', 'NC_CAPA_CREATE', 'NC_CAPA_SCREEN', 'NC_CAPA_ASSIGN_OWNER', 'NC_CAPA_OWNER_ACTION', 'NC_CAPA_RCA_COMPLETE', 'NC_CAPA_PLAN_CREATE', 'NC_CAPA_PLAN_REVIEW'] },
  { id: 'U006', name: 'รัตนพล', position: 'Engineering Supervisor', level: 4, depts: ['EN'], permissions: ['NC_CAPA_VIEW', 'NC_CAPA_CREATE', 'NC_CAPA_OWNER_ACTION', 'NC_CAPA_RCA_COMPLETE', 'NC_CAPA_PLAN_CREATE'] },
  { id: 'U007', name: 'ชัยวัฒน์', position: 'Engineering Assistant Manager', level: 5, depts: ['EN'], permissions: ['NC_CAPA_VIEW', 'NC_CAPA_CREATE', 'NC_CAPA_OWNER_ACTION', 'NC_CAPA_RCA_COMPLETE', 'NC_CAPA_PLAN_CREATE'] },
