...
export const MASTER_DATA_USER = [
  { id: 'U001', name: 'Admin QA (DCC)', position: 'Officer', level: 1, isDcc: true, depts: ['QA'], permissions: ['NC_CAPA_VIEW', 'NC_CAPA_VIEW_ALL', 'NC_CAPA_CREATE', 'NC_CAPA_SCREEN', 'NC_CAPA_ASSIGN_OWNER', 'NC_CAPA_ADMIN', 'NC_CAPA_AUDIT_VIEW', 'NC_CAPA_PLAN_REVIEW', 'NC_CAPA_VERIFY', 'NCR_CREATE_QAQC_ONLY', 'HOLD_CREATE_QAQC_ONLY', 'COMPLAINT_CREATE_QAQC_ONLY', 'NCR_VIEW_ALL', 'HOLD_VIEW_ALL', 'COMPLAINT_VIEW_ALL', 'NCR_FOLLOW_UP', 'NCR_CLOSE', 'HOLD_CLOSE', 'HOLD_DISPOSITION_PROPOSE', 'HOLD_RELEASE_APPROVE', 'QUALITY_EVENT_MANAGEMENT_VIEW', 'QUALITY_EVENT_MANAGEMENT_APPROVE', 'CAPA_VIEW_ALL', 'CAPA_CREATE', 'CAPA_REVIEW', 'CAPA_ASSIGN_OWNER', 'CAPA_VERIFY', 'CAPA_EFFECTIVENESS_CHECK', 'CAPA_CLOSE', 'CAPA_REOPEN', 'CAPA_ADMIN', 'CAPA_AUDIT_VIEW', 'COMPLAINT_ASSIGN_DEPARTMENT', 'COMPLAINT_REVIEW_INVESTIGATION', 'COMPLAINT_CLOSE', 'COMPLAINT_REOPEN', 'COMPLAINT_ADMIN'] },
  { id: 'U002', name: 'ธนาวุฒิ สมควรกิจดำรง', position: 'Production Supervisor', level: 4, depts: ['PD'], permissions: ['NC_CAPA_VIEW', 'NC_CAPA_CREATE', 'NC_CAPA_OWNER_ACTION', 'NC_CAPA_RCA_COMPLETE', 'NC_CAPA_PLAN_CREATE', 'NC_CAPA_ACTION_EXECUTE', 'NC_CAPA_EVIDENCE_SUBMIT', 'NCR_RESPOND', 'HOLD_EXECUTION_UPDATE', 'CAPA_VIEW', 'CAPA_CREATE', 'CAPA_RCA', 'CAPA_PLAN_CREATE', 'CAPA_ACTION_EXECUTE', 'CAPA_EVIDENCE_SUBMIT', 'QUALITY_EVENT_VIEW_RESTRICTED', 'COMPLAINT_VIEW_RESTRICTED', 'COMPLAINT_INVESTIGATE'] },
  { id: 'U003', name: 'กัลยาณี พลไกร', position: 'Production Assistant Manager', level: 5, depts: ['PD', 'QA'], permissions: ['NC_CAPA_VIEW', 'NC_CAPA_CREATE', 'NC_CAPA_OWNER_ACTION', 'NC_CAPA_RCA_COMPLETE', 'NC_CAPA_PLAN_CREATE', 'NC_CAPA_ACTION_EXECUTE', 'NC_CAPA_EVIDENCE_SUBMIT', 'NCR_RESPOND', 'HOLD_EXECUTION_UPDATE', 'CAPA_VIEW', 'CAPA_CREATE', 'CAPA_RCA', 'CAPA_PLAN_CREATE', 'CAPA_ACTION_EXECUTE', 'CAPA_EVIDENCE_SUBMIT', 'QUALITY_EVENT_VIEW_RESTRICTED'] },
  { id: 'U004', name: 'คุณเรย์', position: 'General Manager', level: 6, depts: [], permissions: ['NC_CAPA_VIEW', 'NC_CAPA_VIEW_ALL', 'NC_CAPA_AUDIT_VIEW', 'NCR_VIEW_ALL', 'HOLD_VIEW_ALL', 'CAPA_VIEW_ALL', 'QUALITY_EVENT_MANAGEMENT_VIEW', 'HOLD_RELEASE_APPROVE', 'HOLD_DISPOSITION_APPROVE', 'QUALITY_EVENT_MANAGEMENT_APPROVE', 'COMPLAINT_VIEW_ALL', 'COMPLAINT_APPROVE'] },
  { id: 'U005', name: 'บีม', position: 'QAQC Supervisor', level: 4, depts: ['QA'], permissions: ['NC_CAPA_VIEW', 'NC_CAPA_VIEW_ALL', 'NC_CAPA_CREATE', 'NC_CAPA_SCREEN', 'NC_CAPA_ASSIGN_OWNER', 'NC_CAPA_OWNER_ACTION', 'NC_CAPA_RCA_COMPLETE', 'NC_CAPA_PLAN_CREATE', 'NC_CAPA_PLAN_REVIEW', 'NC_CAPA_ACTION_EXECUTE', 'NC_CAPA_EVIDENCE_SUBMIT', 'NC_CAPA_VERIFY', 'NCR_CREATE_QAQC_ONLY', 'HOLD_CREATE_QAQC_ONLY', 'COMPLAINT_CREATE_QAQC_ONLY', 'NCR_VIEW_ALL', 'HOLD_VIEW_ALL', 'COMPLAINT_VIEW_ALL', 'NCR_FOLLOW_UP', 'NCR_CLOSE', 'HOLD_CLOSE', 'HOLD_DISPOSITION_PROPOSE', 'HOLD_RELEASE_APPROVE', 'QUALITY_EVENT_MANAGEMENT_VIEW', 'CAPA_VIEW_ALL', 'CAPA_CREATE', 'CAPA_REVIEW', 'CAPA_ASSIGN_OWNER', 'CAPA_VERIFY', 'CAPA_EFFECTIVENESS_CHECK', 'CAPA_CLOSE', 'CAPA_REOPEN', 'CAPA_ADMIN', 'CAPA_AUDIT_VIEW', 'COMPLAINT_ASSIGN_DEPARTMENT', 'COMPLAINT_REVIEW_INVESTIGATION', 'COMPLAINT_CLOSE', 'COMPLAINT_REOPEN'] },
  { id: 'U006', name: 'รัตนพล', position: 'Engineering Supervisor', level: 4, depts: ['EN'], permissions: ['NC_CAPA_VIEW', 'NC_CAPA_CREATE', 'NC_CAPA_OWNER_ACTION', 'NC_CAPA_RCA_COMPLETE', 'NC_CAPA_PLAN_CREATE', 'NC_CAPA_ACTION_EXECUTE', 'NC_CAPA_EVIDENCE_SUBMIT', 'NCR_RESPOND', 'HOLD_EXECUTION_UPDATE', 'CAPA_VIEW', 'CAPA_CREATE', 'CAPA_RCA', 'CAPA_PLAN_CREATE', 'CAPA_ACTION_EXECUTE', 'CAPA_EVIDENCE_SUBMIT', 'QUALITY_EVENT_VIEW_RESTRICTED', 'COMPLAINT_VIEW_RESTRICTED', 'COMPLAINT_INVESTIGATE'] },
  { id: 'U007', name: 'ชัยวัฒน์', position: 'Engineering Assistant Manager', level: 5, depts: ['EN'], permissions: ['NC_CAPA_VIEW', 'NC_CAPA_CREATE', 'NC_CAPA_OWNER_ACTION', 'NC_CAPA_RCA_COMPLETE', 'NC_CAPA_PLAN_CREATE', 'NC_CAPA_ACTION_EXECUTE', 'NC_CAPA_EVIDENCE_SUBMIT', 'NCR_RESPOND', 'HOLD_EXECUTION_UPDATE', 'CAPA_VIEW', 'CAPA_CREATE', 'CAPA_RCA', 'CAPA_PLAN_CREATE', 'CAPA_ACTION_EXECUTE', 'CAPA_EVIDENCE_SUBMIT', 'QUALITY_EVENT_VIEW_RESTRICTED'] },
  { id: 'U008', name: 'คุณกิต', position: 'Finance Director', level: 7, depts: [], permissions: ['NC_CAPA_VIEW', 'NC_CAPA_VIEW_ALL', 'NCR_VIEW_ALL', 'HOLD_VIEW_ALL', 'CAPA_VIEW_ALL'] },
  { id: 'U009', name: 'คุณนัท', position: 'Managing Director', level: 8, depts: [], permissions: ['NC_CAPA_VIEW', 'NC_CAPA_VIEW_ALL', 'NC_CAPA_AUDIT_VIEW', 'NCR_VIEW_ALL', 'HOLD_VIEW_ALL', 'CAPA_VIEW_ALL', 'QUALITY_EVENT_MANAGEMENT_VIEW', 'HOLD_RELEASE_APPROVE', 'HOLD_DISPOSITION_APPROVE', 'QUALITY_EVENT_MANAGEMENT_APPROVE', 'COMPLAINT_VIEW_ALL', 'COMPLAINT_APPROVE'] },
  { id: 'U010', name: 'สมชาย การตลาด', position: 'Sales Executive', level: 3, depts: ['MKT'], permissions: ['QUALITY_EVENT_VIEW_RESTRICTED', 'COMPLAINT_VIEW_RESTRICTED', 'COMPLAINT_CUSTOMER_RESPONSE'] }
];
